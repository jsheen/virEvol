...
# Frac of base migration rate for vaccinated chickens migration (sensitivity)
diff_vax = 0.1
...
# Create and save PIP with differential migration due to vaccination -----------
...
write.csv(pip, paste0('~/virEvol/code_output/pips/supplementary/mod3_v33_mfm33_mmf7_c10_diff.csv'))
