...
plot.out.df <- function(out.df) {
  ...
  print(paste0('Vaccinated, farm patch: Res strain = ', round(100 * ((out.df$fV_E1 + out.df$fV_I1)[nrow(out.df)] / vax_farm_patch[nrow(out.df)]), digits=2), 
  ...
  print(paste0('Vaccinated, market patch: Res strain = ', round(100 * ((out.df$mV_E1 + out.df$mV_I1)[nrow(out.df)] / vax_market_patch[nrow(out.df)]), digits=2), 
