...
jpeg('~/virEvol/code_output/testing/equil_plot/baseline_mod1_tradeoff1.jpg')
plot(vir_steps, finalMatrix, type='l', main='baseline_mod1_tradeoff1', ylab='tot change in past 100 days')
dev.off()