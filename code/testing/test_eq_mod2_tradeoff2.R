...
jpeg('~/virEvol/code_output/testing/equil_plot/baseline_mod2_tradeoff2.jpg')
plot(vir_steps, finalMatrix, type='l', main='baseline_mod2_tradeoff2', ylab='tot change in past 100 days')
dev.off()