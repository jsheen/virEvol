...
# Model 3: SEIR with vaccination migration, and slaughter ---------------------------------
multi_eqn_mod4 <- function(time, state, parameters){
  with(as.list(c(state, parameters)),{
    dfS = b*(fS + fE1 + fE2 + fE3 + fE4 + fE5 + fE6 + fE7 + fE8 + fE9 + fE10 + fI1 + fI2 + fI3 + fI4 + fI5 + fI6 + fI7 + fI8 + fI9 + fI10 + fR + 
               fV + fVE1 + fVE2 + fVE3 + fVE4 + fVE5 + fVE6 + fVE7 + fVE8 + fVE9 + fVE10 + fVI1 + fVI2 + fVI3 + fVI4 + fVI5 + fVI6 + fVI7 + fVI8 + fVI9 + fVI10)*(1 - ((fS + fE1 + fE2 + fE3 + fE4 + fE5 + fE6 + fE7 + fE8 + fE9 + fE10 + fI1 + fI2 + fI3 + fI4 + fI5 + fI6 + fI7 + fI8 + fI9 + fI10 + fR + 
                                                                                                                                                                          fV + fVE1 + fVE2 + fVE3 + fVE4 + fVE5 + fVE6 + fVE7 + fVE8 + fVE9 + fVE10 + fVI1 + fVI2 + fVI3 + fVI4 + fVI5 + fVI6 + fVI7 + fVI8 + fVI9 + fVI10) / ((b / (b - nat_mort)) * (pop_size)))) -
      (fbet1*fS*fI1) -(fbet2*fS*fI2) -(fbet3*fS*fI3) -(fbet4*fS*fI4) -(fbet5*fS*fI5) -(fbet6*fS*fI6) -(fbet7*fS*fI7) -(fbet8*fS*fI8) -(fbet9*fS*fI9) -(fbet10*fS*fI10) -
      (fbet1*fS*fVI1) -(fbet2*fS*fVI2) -(fbet3*fS*fVI3) -(fbet4*fS*fVI4) -(fbet5*fS*fVI5) -(fbet6*fS*fVI6) -(fbet7*fS*fVI7) -(fbet8*fS*fVI8) -(fbet9*fS*fVI9) -(fbet10*fS*fVI10) -
      v*fS +v_hat*fV -nat_mort*fS +m_mf*mS*(1-p_s) -m_fm*fS
    ...
    dfE3 = (fbet3*fS*fI3) +(fbet2*fS*fVI3) -sig*fE3 -nat_mort*fE3 +m_mf*mE3*(1-p_s) -m_fm*fE3
    dfE4 = (fbet4*fS*fI4) +(fbet2*fS*fVI4) -sig*fE4 -nat_mort*fE4 +m_mf*mE4*(1-p_s) -m_fm*fE4
    dfE5 = (fbet5*fS*fI5) +(fbet2*fS*fVI5) -sig*fE5 -nat_mort*fE5 +m_mf*mE5*(1-p_s) -m_fm*fE5
    dfE6 = (fbet6*fS*fI6) +(fbet2*fS*fVI6) -sig*fE6 -nat_mort*fE6 +m_mf*mE6*(1-p_s) -m_fm*fE6
    dfE7 = (fbet7*fS*fI7) +(fbet2*fS*fVI7) -sig*fE7 -nat_mort*fE7 +m_mf*mE7*(1-p_s) -m_fm*fE7
    dfE8 = (fbet8*fS*fI8) +(fbet2*fS*fVI8) -sig*fE8 -nat_mort*fE8 +m_mf*mE8*(1-p_s) -m_fm*fE8
    dfE9 = (fbet9*fS*fI9) +(fbet2*fS*fVI9) -sig*fE9 -nat_mort*fE9 +m_mf*mE9*(1-p_s) -m_fm*fE9
    dfE10 = (fbet10*fS*fI10) +(fbet2*fS*fVI10) -sig*fE10 -nat_mort*fE10 +m_mf*mE10*(1-p_s) -m_fm*fE10
    ...
    dfI3 = sig*fE3 -gamm*(1-p_3)*fI3 -mort*p_3*fI3 -nat_mort*fI3 +m_mf*mI3*(1-p_s) -m_fm*fI3
    dfI4 = sig*fE4 -gamm*(1-p_4)*fI4 -mort*p_4*fI4 -nat_mort*fI4 +m_mf*mI4*(1-p_s) -m_fm*fI4
    dfI5 = sig*fE5 -gamm*(1-p_5)*fI5 -mort*p_5*fI5 -nat_mort*fI5 +m_mf*mI5*(1-p_s) -m_fm*fI5
    dfI6 = sig*fE6 -gamm*(1-p_6)*fI6 -mort*p_6*fI6 -nat_mort*fI6 +m_mf*mI6*(1-p_s) -m_fm*fI6
    dfI7 = sig*fE7 -gamm*(1-p_7)*fI7 -mort*p_7*fI7 -nat_mort*fI7 +m_mf*mI7*(1-p_s) -m_fm*fI7
    dfI8 = sig*fE8 -gamm*(1-p_8)*fI8 -mort*p_8*fI8 -nat_mort*fI8 +m_mf*mI8*(1-p_s) -m_fm*fI8
    dfI9 = sig*fE9 -gamm*(1-p_9)*fI9 -mort*p_9*fI9 -nat_mort*fI9 +m_mf*mI9*(1-p_s) -m_fm*fI9
    dfI10 = sig*fE10 -gamm*(1-p_10)*fI10 -mort*p_10*fI10 -nat_mort*fI10 +m_mf*mI10*(1-p_s) -m_fm*fI10
    dfR = gamm*(1-p_1)*fI1 +gamm*(1-p_2)*fI2 +gamm*(1-p_3)*fI3 +gamm*(1-p_4)*fI4 +gamm*(1-p_5)*fI5 +gamm*(1-p_6)*fI6 +gamm*(1-p_7)*fI7 +gamm*(1-p_8)*fI8 +gamm*(1-p_9)*fI9 +gamm*(1-p_10)*fI10 +
      gamm*fVI1 +gamm*fVI2 +gamm*fVI3 +gamm*fVI4 +gamm*fVI5 +gamm*fVI6 +gamm*fVI7 +gamm*fVI8 +gamm*fVI9 +gamm*fVI10 -nat_mort*fR
    dfV = -(fbet1*fV*fI1) -(fbet2*fV*fI2) -(fbet1*fV*fVI1) -(fbet2*fV*fVI2) +v*fS -v_hat*fV -nat_mort*fV +m_mf*mR*(1-p_s) -m_fm*fR
    dfVE1 = (fbet1*fV*fI1) +(fbet1*fV*fVI1) -sig*fVE1 -nat_mort*fVE1 +m_mf*mVE1*(1-p_s) -m_fm*fVE1
    dfVE2 = (fbet2*fV*fI2) +(fbet2*fV*fVI2) -sig*fVE2 -nat_mort*fVE2 +m_mf*mVE2*(1-p_s) -m_fm*fVE2
    dfVE3 = (fbet3*fV*fI3) +(fbet3*fV*fVI3) -sig*fVE3 -nat_mort*fVE3 +m_mf*mVE3*(1-p_s) -m_fm*fVE3
    dfVE4 = (fbet4*fV*fI4) +(fbet4*fV*fVI4) -sig*fVE4 -nat_mort*fVE4 +m_mf*mVE4*(1-p_s) -m_fm*fVE4
    dfVE5 = (fbet5*fV*fI5) +(fbet5*fV*fVI5) -sig*fVE5 -nat_mort*fVE5 +m_mf*mVE5*(1-p_s) -m_fm*fVE5
    dfVE6 = (fbet6*fV*fI6) +(fbet6*fV*fVI6) -sig*fVE6 -nat_mort*fVE6 +m_mf*mVE6*(1-p_s) -m_fm*fVE6
    dfVE7 = (fbet7*fV*fI7) +(fbet7*fV*fVI7) -sig*fVE7 -nat_mort*fVE7 +m_mf*mVE7*(1-p_s) -m_fm*fVE7
    dfVE8 = (fbet8*fV*fI8) +(fbet8*fV*fVI8) -sig*fVE8 -nat_mort*fVE8 +m_mf*mVE8*(1-p_s) -m_fm*fVE8
    dfVE9 = (fbet9*fV*fI9) +(fbet9*fV*fVI9) -sig*fVE9 -nat_mort*fVE9 +m_mf*mVE9*(1-p_s) -m_fm*fVE9
    dfVE10 = (fbet10*fV*fI10) +(fbet10*fV*fVI10) -sig*fVE10 -nat_mort*fVE10 +m_mf*mVE10*(1-p_s) -m_fm*fVE10
    dfVI1 = sig*fVE1 -gamm*fVI1 -nat_mort*fVI1 +m_mf*mVI1*(1-p_s) -m_fm*fVI1
    dfVI2 = sig*fVE2 -gamm*fVI2 -nat_mort*fVI2 +m_mf*mVI2*(1-p_s) -m_fm*fVI2
    dfVI3 = sig*fVE3 -gamm*fVI3 -nat_mort*fVI3 +m_mf*mVI3*(1-p_s) -m_fm*fVI3
    dfVI4 = sig*fVE4 -gamm*fVI4 -nat_mort*fVI4 +m_mf*mVI4*(1-p_s) -m_fm*fVI4
    dfVI5 = sig*fVE5 -gamm*fVI5 -nat_mort*fVI5 +m_mf*mVI5*(1-p_s) -m_fm*fVI5
    dfVI6 = sig*fVE6 -gamm*fVI6 -nat_mort*fVI6 +m_mf*mVI6*(1-p_s) -m_fm*fVI6
    dfVI7 = sig*fVE7 -gamm*fVI7 -nat_mort*fVI7 +m_mf*mVI7*(1-p_s) -m_fm*fVI7
    dfVI8 = sig*fVE8 -gamm*fVI8 -nat_mort*fVI8 +m_mf*mVI8*(1-p_s) -m_fm*fVI8
    dfVI9 = sig*fVE9 -gamm*fVI9 -nat_mort*fVI9 +m_mf*mVI9*(1-p_s) -m_fm*fVI9
    dfVI10 = sig*fVE10 -gamm*fVI10 -nat_mort*fVI10 +m_mf*mVI10*(1-p_s) -m_fm*fVI10
