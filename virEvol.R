...
# - Vaccination completely protects chickens from mortality
...
eqn <- function(time, state, parameters){
    with(as.list(c(state, parameters)),{
      ...
      dfE2 = fbet2*fS*fI2 +fbet2*fS*fI2_r -sig*fE2 -m_fm*fE2 +m_mf*mE2
      dfI1 = sig*fE1 -gamm*(1-p_1)*fI1 -gamm*p_1*fI1
      dfI2 = sig*fE2 -gamm*(1-p_2)*fI2 -gamm*p_2*fI2
      dfR1 = gamm*(1-p_1)*fI1 -theta*fR1 -m_fm*fR1 +m_mf*mR1
      dfR2 = gamm*(1-p_2)*fI2 -theta*fR2 -m_fm*fR2 +m_mf*mR2
      dD = gamm*p_1*fI1 +gamm*p_2*fI2 +gamm*p_r*fR1_r +gamm*p_r*fR2_r +gamm*p_1*mI1 +gamm*p_2*mI2 +gamm*p_r*fR2_r +gamm*p_r*mR2_r
      dfV = v*(fS) -v_hat*fV -
            fbet1*fV*fI1 -fbet2*fV*fI2 -
            fbet1*fV*fI1_r -fbet2*fV*fI2_r +
            gamm*fV_I1 +gamm*fV_I2 -
            m_fm*fV + m_mf*mV 
      dfV_E1 = fbet1*fV*fI1 +fbet1*fV*fI1_r -sig*fV_E1 -m_fm*fV_E1 +m_mf*mV_E1
      dfV_I1 = sig*fV_E1 -gamm*fV_I1 -m_fm*fV_I1 +m_mf*mV_I1
      dfV_E2 = fbet2*fV*fI2 +fbet2*fV*fI2_r -sig*fV_E2 -m_fm*fV_E2 +m_mf*mV_E2
      dfV_I2 = sig*fV_E2 -gamm*fV_I2 -m_fm*fV_I2 +m_mf*mV_I2
      ...
      dfI1_r = sig*fE1_r -gamm*(1-p_r)*fI1_r -gamm*p_r*fI1_r
      dfI2_r = sig*fE2_r -gamm*(1-p_r)*fI2_r -gamm*p_r*fI2_r
      dfR1_r = gamm*(1-p_r)*fI1_r -theta*fR1_r -m_fm*fR1_r +m_mf*mR1_r
      dfR2_r = gamm*(1-p_r)*fI2_r -theta*fR2_r -m_fm*fR2_r +m_mf*mR2_r
      dfV_r = v*(fS_r) -v_hat*fV_r -
              fbet1*fV_r*fI1 -fbet2*fV_r*fI2 -
              fbet1*fV_r*fI1_r -fbet2*fV_r*fI2_r +
              gamm*fV_r_I1 +gamm*fV_r_I2 -
              m_fm*fV_r +m_mf*mV_r
      dfV_r_E1 = fbet1*fV_r*fI1 +fbet1*fV_r*fI1_r -sig*fV_r_E1 -m_fm*fV_r_E1 +m_mf*mV_r_E1
      dfV_r_I1 = sig*fV_r_E1 -gamm*fV_r_I1 -m_fm*fV_r_I1 +m_mf*mV_r_I1
      dfV_r_E2 = fbet2*fV_r*fI2 +fbet2*fV_r*fI2_r -sig*fV_r_E2 -m_fm*fV_r_E2 +m_mf*mV_r_E2
      dfV_r_I2 = sig*fV_r_E2 -gamm*fV_r_I2 -m_fm*fV_r_I2 +m_mf*mV_r_I2

      # Live bird markets
      dmS = -mbet1*mS*mI1 -mbet2*mS*mI2 -m_mf*mS +m_fm*fS # No vaccination within live markets
      dmE1 = mbet1*mS*mI1 +mbet1*mS*mI1_r -sig*mE1 -m_mf*mE1 +m_fm*fE1
      dmE2 = mbet2*mS*mI2 +mbet2*mS*mI2_r -sig*mE2 -m_mf*mE2 +m_fm*fE2 
      dmI1 = sig*mE1 -gamm*(1-p_1)*mI1 -gamm*p_1*mI1
      dmI2 = sig*mE2 -gamm*(1-p_2)*mI2 -gamm*p_2*mI2
      dmR1 = gamm*(1-p_1)*mI1 -theta*mR1 -m_mf*mR1 +m_fm*fR1
      dmR2 = gamm*(1-p_2)*mI2 -theta*mR2 -m_mf*mR2 +m_fm*fR2
      dmV = -v_hat*mV -
            mbet1*mV*mI1 -mbet1*mV*mI1_r -
            mbet2*mV*mI2 -mbet2*mV*mI2_r +
            gamm*mV_I1 + gamm*mV_I2 +
            m_fm*fV -m_mf*mV
      dmV_E1 = mbet1*mV*mI1 +mbet1*mV*mI1_r -sig*mV_E1 +m_fm*fV_E1 -m_mf*mV_E1
      dmV_I1 = sig*mV_E1 -gamm*mV_I1 +m_fm*fV_I1 -m_mf*mV_I1
      dmV_E2 = mbet2*mV*fI2 +mbet2*mV*fI2_r -sig*mV_E2 +m_fm*fV_E2 -m_mf*mV_E2
      dmV_I2 = sig*mV_E2 -gamm*mV_I2 +m_fm*fV_I2 -m_mf*mV_I2
      ...
      dmI1_r = sig*mE1_r -gamm*(1-p_r)*mI1_r -gamm*p_r*mI1_r
      dmI2_r = sig*mE2_r -gamm*(1-p_r)*mI2_r -gamm*p_r*mI2_r
      dmR1_r = gamm*(1-p_r)*mI1_r -theta*mR1_r -m_mf*mR1_r +m_fm*fR1_r
      dmR2_r = gamm*(1-p_r)*mI2_r -theta*mR2_r -m_mf*mR2_r +m_fm*fR2_r
      dmV_r = -v_hat*mV_r -
              mbet1*mV_r*mI1 -mbet1*mV_r*mI1_r -
              mbet2*mV_r*mI2 -mbet2*mV_r*mI2_r +
              gamm*mV_I1 +gamm*mV_I2 +
              m_fm*fV_r -m_mf*mV_r 
      dmV_r_E1 = mbet1*mV_r*mI1 +mbet1*mV_r*mI1_r -sig*mV_r_E1 +m_fm*fV_r_E1 -m_mf*mV_r_E1
      dmV_r_I1 = sig*mV_r_E1 -gamm*mV_r_I1 +m_fm*fV_r_I1 -m_mf*mV_r_I1
      dmV_r_E2 = mbet2*mV_r*fI2 +mbet2*mV_r*fI2_r -sig*mV_r_E2 +m_fm*fV_r_E2 -m_mf*mV_r_E2
      dmV_r_I2 = sig*mV_r_E2 -gamm*mV_r_I2 +m_fm*fV_r_I2 -m_mf*mV_r_I2
